...
# If FFIGEN is defined in the environment, use that as the
...
# If SYS_INCLUDE is defined in the environment, use that as the
# subdirectory under /usr/include corresponding to #include <sys/...>
# Normally, this is just "sys" but on systems with multi-architecture
# support, it can be different (e.g., "aarch64-linux-gnu/sys")

if [ -z  "${SYS_INCLUDE}" ]; then
    SYS_INCLUDE=sys
fi
...
translate /usr/include/${SYS_INCLUDE}/ipc.h
translate /usr/include/${SYS_INCLUDE}/mman.h
translate /usr/include/${SYS_INCLUDE}/msg.h
translate /usr/include/${SYS_INCLUDE}/resource.h
translate /usr/include/${SYS_INCLUDE}/select.h
translate /usr/include/${SYS_INCLUDE}/sem.h
translate /usr/include/${SYS_INCLUDE}/shm.h
translate /usr/include/${SYS_INCLUDE}/socket.h
translate /usr/include/${SYS_INCLUDE}/stat.h
translate /usr/include/${SYS_INCLUDE}/statvfs.h
translate /usr/include/${SYS_INCLUDE}/time.h
translate /usr/include/${SYS_INCLUDE}/times.h
translate /usr/include/${SYS_INCLUDE}/types.h
translate /usr/include/${SYS_INCLUDE}/uio.h
translate /usr/include/${SYS_INCLUDE}/un.h
translate /usr/include/${SYS_INCLUDE}/utsname.h
translate /usr/include/${SYS_INCLUDE}/wait.h
