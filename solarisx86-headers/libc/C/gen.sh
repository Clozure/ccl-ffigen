...
# For 32-bit illumos/OmniOS/Solaris-ish
...
{
    includes=""
    platform_flags="-m32 -D_REENTRANT -D__EXTENSIONS__"
    ...
    echo $1
    "$FFIGEN" $platform_flags -x c -isystem /usr/include $includes "$1" \
	    -o "$output_path"
}
...
translate -include /usr/include/sys/types.h /usr/include/netinet/tcp.h
...
translate /usr/include/sys/regset.h
translate /usr/include/ifaddrs.h
translate /usr/include/sys/elf.h
translate /usr/include/sys/link.h
translate /usr/include/sys/processor.h
